# Aura Mascot Upgrades Roadmap

This document tracks the planned upgrades to transform Aura from a reactive notification orb into a proactive, indispensable AI companion.
...
- [ ] **Streak Glow**: Add intense glowing or particle effects when the user is on a study streak or scores high mastery.
- [ ] **Unlockable Skins**: Implement a system to unlock new orb skins (e.g., Nebula, Quantum) based on XP or mastery milestones.
...
- [ ] **Prompt Integration**: Pass the selected personality to the backend AI to adjust the tone of Aura's messages.
- [ ] **Personality-Specific Visuals**: Tweak Aura's default colors based on personality (e.g., blue for Socratic, green/yellow for Cheerleader).

---

### Current Focus: Phase 1
We are starting with **1. Contextual Workspace Tools**, specifically the **Highlight-to-Explain** and **Quick Chat popover** features.
